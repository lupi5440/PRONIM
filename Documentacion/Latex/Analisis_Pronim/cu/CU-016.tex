...
%--------------------------------------
\begin{UseCase}{CU-016}{Modificar grupos}{
 ...
 Dado algún problema con un grupo o la escuela donde ya no se pueda disponer o bien del instituto o del profesor, el profesor encargado del grupo o alguien de mayor jerarquía podrá modificar la asignación de los alumnos de un grupo a otro grupo o instituto si es necesario. % Duda si es modificacion de solo algunos o todo el grupo en general
}
