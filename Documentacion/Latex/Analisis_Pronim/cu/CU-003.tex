...
%--------------------------------------
\begin{UseCase}{CU-003}{Visualizar lista de docentes}{
 ...
 Dado un inicio de sesión exitoso por parte del director de centro de trabajo o alguien de mayor grado, podra dar click en lista de docente, donde lo llevara a la IU003-1 que cambiara su contenido dependiendo del filtro aplicado por el usuario (Nombre de escuela,Nivel educativo del docente,Estado,Lenguas)
}
	...
	% TODO: Dar de alta al actor Usuario
		...
		\hyperlink{Usuarios}{} % No olvide dar de alta el actor.
